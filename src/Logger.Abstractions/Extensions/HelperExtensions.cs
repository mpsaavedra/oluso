...
namespace Oluso.Logger.Abstractions.Extensions;
...
public static class HelperExtensions
{
    ...
    ///     {
    ///         var opts = configuration.ToSerilogConfigureOrDefault();
    ///         returns opts;
    ///     }
    /// }
    ///
    ...
    /// <returns></returns>
    public static TOptions ToSerilogConfigureOrDefault<TOptions>(this Action<TOptions?> action,
