...
{
    /// <summary>
    /// gets a Queryable result of the <see cref="TEntity"/> DbSet to make read operations
    /// </summary>
    ...
    /// <summary>
    /// returns the how many elements are of <typeparam name="TEntity">TEntity</typeparam>
    /// </summary>
    /// <returns></returns>
    ...
    /// <summary>
    /// returns true if theres any element of <typeparam name="TEntity">TEntity</typeparam>
    /// </summary>
    /// <returns></returns>
