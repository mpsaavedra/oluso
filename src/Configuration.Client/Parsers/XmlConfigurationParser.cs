...
/// <summary>
/// Xml file configuration parser. it parse the configuration stream asumming that
/// the stream contains an xml file format and returns the <see cref="IDictionary{TKey, TValue}"/>
